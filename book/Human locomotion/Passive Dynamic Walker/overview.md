...
|---------------------|----------|---------------|
| [Slotted Spring Pins, 2 mm Diameter, 30 mm Long. McMaster Part No. 97161A113] (https://www.mcmaster.com/97161A113/)     | 2    | $13.03 USD for 100 |
...
<a href=./CMU_PassiveDynamicWalker_CAD.zip class="btn btn-primary">
...
### Lesson Slides
<a href=./CMU_NBD_PassiveDynamicWalker.pdf class="btn btn-primary">
    <i class="fas fa-download"></i> Download slides
</a>

<iframe src=./CMU_NBD_PassiveDynamicWalker.pdf width="800" height="450" style="border:none;"></iframe>
